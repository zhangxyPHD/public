#!/bin/bash 
#SBATCH -J We50-3             # Job name which can be changed
#SBATCH -p batch        # partition name
#SBATCH -o out-We50-3.txt    # Output file name
#SBATCH -e error-We50-3.txt    # Error file name
#SBATCH --nodes=1
#SBATCH --ntasks=128
...
Ohs=(0.2 0.25 0.3 0.4 0.5 0.6 0.8 1.0 1.5 2.0) #10
Js=(0.3 0.25 0.2 0.15 0.1 0.08 0.06 0.04 0.02 0.01 0.005 0)  #12
epsilons=(1e-3)
tmax=20
DT=1e-4
CFL=0.01
